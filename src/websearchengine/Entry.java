...
public class Entry {
  ...
  public static void main(String args[]) throws Exception {
    ...
    System.out.println(
      "Do you want to search by word(w) or URL(u)? \n"
    );
    ...
    while (true) {
      ...
      if (sc.nextInt() == 0) {
        System.out.println("Thank you for using the web search engine. \n");
        break;
      }
      ...
      //Sorting
        ...
        System.out.println(
          "How do you want to sort the result? By Rank(r) or by Alphabetical Order(a): "
        );
